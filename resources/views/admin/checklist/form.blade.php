...
@csrf
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="form-group mb-3">
                <label for="instructions" class="form-label text-primary">Instructions</label>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group mb-3">
                <label for="nthDayTarget" class="form-label text-primary">Nth Day Target <span class="required">*</span></label>
        ...
        <div class="col-sm-4">
            <div class="mb-3">
                <label for="sequence" class="form-label text-primary">Sequence No.</label>
