...
@endphp
 <nav class="navbar">
        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="languageDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="flag-icon flag-icon-{{ $profileData->country }} mt-1" title="{{ $profileData->country }}"></i> <span class="ms-1 me-1 d-none d-md-inline-block">{{ $profileData->username }}</span>
                </a>
    ...
    <div class="p-1">
        ...
        <div class="me-3">
            <img class="wd-30 ht-30  rounded-circle" src="{{ !empty($profileData->photo) ? url('upload/admin_images/'.$profileData->photo) : url('upload/no_image.jpg')  }}" alt="profile photo">
        </div>
        ...
        <div class="d-flex justify-content-between flex-grow-1">
            ...
            <p class="tx-12 text-muted">Project dateline</p>
            </div>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80  rounded-circle" src="{{ !empty($profileData->photo) ? url('upload/admin_images/'.$profileData->photo) : url('upload/no_image.jpg')  }}" alt="profile photo">
                        </div>
    ...
    <ul class="list-unstyled p-1">
        ...
        <a href="{{ route('view.edit.profile', Auth::user()->id) }}" class="text-body ms-0">
